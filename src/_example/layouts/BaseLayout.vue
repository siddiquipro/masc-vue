<template>
  <div>
    <SideBar
      ...
      class="fixed top-0 left-0 z-20 h-full pb-10 overflow-x-hidden overflow-y-auto transition origin-left transform bg-white border-r w-60 lg:translate-x-0"
    />
    <div class="ml-0 transition lg:ml-60">
