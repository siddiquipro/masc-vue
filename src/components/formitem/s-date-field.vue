<template>
  <div class="datepicker relative w-full">
    <div class="relative w-full ignore">
      <input type="text" readonly :value="displayFormat" v-bind="$attrs" @focus.prevent.stop="open" class="input ignore w-full pr-10" />
      <div class="h-full w-10 flex items-center justify-center absolute top-0 right-0 cursor-pointer">
