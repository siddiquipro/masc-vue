...
const mascPlugin = plugin(function ({ addBase, addComponents }) {
	...
	addComponents({
		...
		".input,.select,.textarea": {
			"@apply px-3 focus:outline-none focus-visible:outline-none focus-within:outline-none border border-base-300 focus:border-primary focus:ring-1 focus:ring-primary":
				{},
		},
		".input-sm": {
			"@apply px-2": {},
